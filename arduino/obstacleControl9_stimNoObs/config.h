...
const float obstacleLocations[] = {1.5, rewardRotations*20}; // expressed in wheel ticks // the last element is a hack... the index goes up and the wheel position will never reach the last value, which is the desired behavior
...
const int obsPosJitter[] = {0, 1196}; // jitter range for the onset position of obstacles (mm)
